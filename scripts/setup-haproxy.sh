...
IP_WORKER0=192.168.0.90
IP_WORKER1=192.168.0.91
IP_WORKER2=192.168.0.92
...
sed -Ezi "s/IP_MASTER0/$IP_WORKER0/g" extras/haproxy.cfg
sed -Ezi "s/IP_MASTER1/$IP_WORKER1/g" extras/haproxy.cfg
sed -Ezi "s/IP_MASTER2/$IP_WORKER2/g" extras/haproxy.cfg
